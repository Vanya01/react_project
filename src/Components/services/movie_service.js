...
const SEARCH = async (page) => await axios.get(`https://api.themoviedb.org/3/search/movie?api_key=<<api_key>>&language=en-US&page=1&include_adult=false`);
...
export {getMovies, getGenres, API_KEY,SEARCH};
